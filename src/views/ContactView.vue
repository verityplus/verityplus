  ...
  <section class="bg-background py-16 px-6 sm:py-24">
    <div class="container-page">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div class="space-y-8">
            <div v-for="info in contactInfo" :key="info.label" class="flex items-start gap-4">
              <div class="flex-shrink-0 w-12 h-12 bg-primary-100 text-primary rounded-[var(--radius-lg)] flex items-center justify-center">
        ...
        <div class="bg-surface p-8 rounded-[var(--radius-2xl)] border border-border shadow-[var(--shadow-card)]">
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <button type="submit" class="btn-primary w-full py-4 text-base shadow-lg hover:shadow-xl transition duration-300 hover:-translate-y-0.5">
              Kirim Pesan
            </button>
          </form>
        </div>
