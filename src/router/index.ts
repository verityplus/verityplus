...

    {
      ...
      children: [
        ...
        },
        {
          path: 'authors',
          name: 'cms-authors',
          component: () => import('../features/cms/views/AuthorListView'),
          meta: { title: 'Manage Authors | CMS' },
        },
        {
          path: 'authors/new',
          name: 'cms-authors-new',
          component: () => import('../features/cms/views/AuthorEditorView'),
          meta: { title: 'New Author | CMS' },
        },
        {
          path: 'authors/:id/edit',
          name: 'cms-authors-edit',
          component: () => import('../features/cms/views/AuthorEditorView'),
          meta: { title: 'Edit Author | CMS' },
        },
        {
          path: 'categories',
          name: 'cms-categories',
